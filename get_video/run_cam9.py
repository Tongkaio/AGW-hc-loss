...
CAM_ID = '8'  # 摄像头编号
ENVIRONMENT = 'day'+'_outdoor'  # 环境
DEV_IP = create_string_buffer(b'192.168.1.69')  # 网络摄像头的IP地址
