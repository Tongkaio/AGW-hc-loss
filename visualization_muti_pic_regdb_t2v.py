...
def visualization(distmat, q_pids, g_pids, g_imgs, q_img):  # 相似度
    ...
    visualization_save = r'D:\pythoncode\AGW-hc-loss\visualization_save_regdb_t2v'
...
if dataset == 'regdb':
    ...
    # testing set
    pic_path = ['Thermal/212/male_back_t_07426_212.bmp 0',
                'Thermal/274/female_front_t_03505_274.bmp 1',
                'Thermal/171/male_front_t_04317_171.bmp 2',
                'Thermal/170/male_front_t_04360_170.bmp 3']

    query_img, query_label = process_muti_query_regdb(pic_path)
    gall_img, gall_label = process_test_regdb(data_path, trial=2, modal='visible') # trial影响抽取的数据集，我这里用的是2，不可以修改的哦
    ...
    gall_img, gall_label = process_test_regdb(data_path, trial=2, modal='visible')
    ...
    gall_feat_fc = np.load('gall_feat_fc_t2v_regdb.npy')
...
#  python visualization_muti_pic_regdb_t2v.py --resume regdb_agw_p4_n8_lr_0.1_seed_0_drop_0.5_whc_0.2_trial_1_best.t --dataset regdb