...
def visualization(distmat, q_pids, g_pids, q_camids, g_camids, g_imgs, q_img):  # 相似度
    ...
    visualization_save = r'D:\pythoncode\AGW-hc-loss\visualization_save3'
...
if dataset == 'sysu':
    ...
    # testing set
    pic_path = [r'D:\pythoncode\SYSU-MM01\ori_data\cam2\0063\0001.jpg',
                r'D:\pythoncode\SYSU-MM01\ori_data\cam1\0010\0014.jpg',
                r'D:\pythoncode\SYSU-MM01\ori_data\cam4\0034\0010.jpg',
                r'D:\pythoncode\SYSU-MM01\ori_data\cam2\0108\0027.jpg']
    ...
    gall_feat_fc = np.load('gall_feat_fc_v2t_sysu.npy')
...
#  python visualization_muti_pic_sysu_v2t.py --resume sysu_agw_p4_n8_lr_0.1_seed_0_drop_0.5_whc_0.4_best.t --dataset sysu --model_path visible2thermal/